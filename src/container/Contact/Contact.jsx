      ...
      <div className='contact__content'>
        ...
        <div className='contact__content--main'>
          <div className='contact__left'>
            ...
            <div className='contact__left--two'>
              <form action="">
                ...
                <label htmlFor="Email"><p><b>Email:</b></p></label>
                <input type="text" id="email" required />

                <label htmlFor="Phone Number"><p><b>Phone Number:</b></p></label>
                <input type="text" id="phone" required />

                <label htmlFor="Message"><p><b>Message:</b></p></label>
                <textarea type="message" rows="4" required ></textarea>
          ...
          <div className="contact__right">
            ...
            <div className="contact__email"><img src="https://img.icons8.com/material-sharp/24/000000/new-post.png" alt='Email icon - (Icon8)' className="icon"/><p>omoikefarms@gmail.com</p></div>
          </div>
        </div>
